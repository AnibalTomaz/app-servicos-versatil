...
function centralEnsureSheets_(ss){['META','ROOMS','CATEGORIES','PRODUCTS','CLOSURES','ORDERS','LEISURE','ITINERARIES'].forEach(n=>{if(!ss.getSheetByName(n))ss.insertSheet(n)})}
