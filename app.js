...
const UI_ICON_ASSETS_V179={
  checkin:'ui-icons-v179/checkin-walk.png',
  noVisitorParking:'ui-icons-v179/no-visitor-parking.png',
  noPets:'ui-icons-v179/no-pets.png',
  loftSolo:'ui-icons-v179/bed-loft-solo.png',
  loftSolteiro:'ui-icons-v179/bed-loft-solteiro.png',
  casalStudio:'ui-icons-v179/bed-casal-studio.png',
  master:'ui-icons-v179/bed-master.png',
  studioTriplo:'ui-icons-v179/bed-studio-triplo.png'
};
function assetIconV179(src,extra=''){
...
function versatilItemIconV179(item){
  ...
  if(id==='loft-solo')return assetIconV179(UI_ICON_ASSETS_V179.loftSolo,'bed-ref');
  if(id==='loft-solteiro')return assetIconV179(UI_ICON_ASSETS_V179.loftSolteiro,'bed-ref');
  if(id==='loft-casal'||id==='studio-casal')return assetIconV179(UI_ICON_ASSETS_V179.casalStudio,'bed-ref');
  if(id==='studio-triplo')return assetIconV179(UI_ICON_ASSETS_V179.studioTriplo,'bed-ref');
  if(id==='master')return assetIconV179(UI_ICON_ASSETS_V179.master,'bed-ref master-ref');
  if(id==='n10'||String(item?.name||'').toLowerCase()==='check-in / check-out')return assetIconV179(UI_ICON_ASSETS_V179.checkin,'rule-ref');
  if(id==='n4'||String(item?.name||'').toLowerCase().includes('vagas para visitantes'))return assetIconV179(UI_ICON_ASSETS_V179.noVisitorParking,'rule-ref');
  if(id==='n5'||String(item?.name||'').toLowerCase().includes('aceitamos pets'))return assetIconV179(UI_ICON_ASSETS_V179.noPets,'rule-ref');
