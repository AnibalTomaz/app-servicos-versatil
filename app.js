...
const APP_BUILD='1780-accommodation-icons-reference';
...
function render(){
  ...
  renderVersionBadge();
  setTimeout(()=>{updatePwaInstallUI();updateCentralStatusUI();updateItineraryCountUI();if(page==='leisure')setupLeisureExclusiveAccordion();if(page==='postal')bindPostalValidation();adjustScrollBelowHeaderV177(false);},0);
}
