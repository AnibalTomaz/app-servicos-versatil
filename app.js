...
const APP_BUILD='1750-header-three-columns';
...
function appView(){
  ...
  return `<header class="top top-v175">
    ...
    <div class="header-col header-col-actions">
      ...
      ${admin?centralStatusHtml():`<button class="header-normas-btn header-action-v175" onclick="page='normas';render()">Normas gerais</button>`}
    </div>
